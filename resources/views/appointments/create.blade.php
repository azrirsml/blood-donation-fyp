<x-app-layout>
    ...
    <div class="p-5 bg-white rounded-lg shadow-md">
        <form action="{{ route('appointments.store') }}" method="POST" class="space-y-8 divide-y divide-gray-200">
            @csrf
                ...
                <div class="pt-2">
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="text" name="donor_name" class="shadow-sm focus:ring-teal-500 focus:border-teal-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="email" name="donor_email" class="shadow-sm focus:ring-teal-500 focus:border-teal-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="text" name="donor_contact" class="shadow-sm focus:ring-teal-500 focus:border-teal-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                         <div class="sm:col-span-3">
